...
class JenisUser extends StatefulWidget {
  const JenisUser({Key? key}) : super(key: key);

  @override
  State<JenisUser> createState() => _JenisUserState();
}

class _JenisUserState extends State<JenisUser> {
              ...
              return Container(
                  ...
                  child: TextFormField(
                    ...
                    decoration: InputDecoration(
                      ...
                      hintText: listdata1[index].jenisKelamin!,
