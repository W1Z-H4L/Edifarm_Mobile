...
class CountActI extends StatefulWidget {
  const CountActI({super.key});

  @override
  State<CountActI> createState() => _CountState();
}

class _CountState extends State<CountActI> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    super.initState();
    listblog = ServiceApiCountActIri().getData();
    listblog.then((value) {
      setState(() {
        listblog1 = value;
      });
