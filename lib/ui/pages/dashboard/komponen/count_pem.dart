...
class CountPP extends StatefulWidget {
  const CountPP({super.key});

  @override
  State<CountPP> createState() => _CountState();
}

class _CountState extends State<CountPP> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    super.initState();
    listblog = ServiceApiCountPem().getData();
    listblog.then((value) {
      setState(() {
        listblog1 = value;
      });
            ...
            itemBuilder: (context, index) {
              return Padding(
                ...
                child: Row(
                  ...
                  children: <Widget>[
                    Text(
                      listblog1[index].cOUNTKegiatan! + " Kali",
