...
class CountActL extends StatefulWidget {
  const CountActL({super.key});

  @override
  State<CountActL> createState() => _CountState();
}

class _CountState extends State<CountActL> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    super.initState();
    listblog = ServiceApiCountActLain().getData();
    listblog.then((value) {
      setState(() {
        listblog1 = value;
      });
