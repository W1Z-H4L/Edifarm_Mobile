...
class AlamatUser extends StatefulWidget {
  const AlamatUser({Key? key}) : super(key: key);

  @override
  State<AlamatUser> createState() => _AlamatUserState();
}

class _AlamatUserState extends State<AlamatUser> {
              ...
              return Container(
                  ...
                  child: TextFormField(
                    ...
                    decoration: InputDecoration(
                      ...
                      labelText: 'Alamat',
                      hintText: listdata1[index].alamat!,
