...
class CountP extends StatefulWidget {
  const CountP({super.key});

  @override
  State<CountP> createState() => _CountState();
}

class _CountState extends State<CountP> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    super.initState();
    listblog = ServiceApiCountPes().getData();
    listblog.then((value) {
      setState(() {
        listblog1 = value;
      });
