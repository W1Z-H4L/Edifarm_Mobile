...
class CountI extends StatefulWidget {
  const CountI({super.key});

  @override
  State<CountI> createState() => _CountState();
}

class _CountState extends State<CountI> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    super.initState();
    listblog = ServiceApiCountIri().getData();
    listblog.then((value) {
      setState(() {
        listblog1 = value;
      });
